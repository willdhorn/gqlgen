...
func (ec *executionContext) unmarshalONestedMapInput2ᚖgithubᚗcomᚋwilldhornᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐNestedMapInput(ctx context.Context, v interface{}) (*NestedMapInput, error) {
	if v == nil {
		return nil, nil
	}
