...
func (ec *executionContext) marshalOOverlappingFields2ᚖgithubᚗcomᚋwilldhornᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐOverlappingFields(ctx context.Context, sel ast.SelectionSet, v *OverlappingFields) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
